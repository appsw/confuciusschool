...
Ds _$DsFromJson(Map<String, dynamic> json) {
  return Ds(json['id'] as int, json['name'] as String, json['currid'] as int,
...
Res _$ResFromJson(Map<String, dynamic> json) {
  return Res(json['id'] as int, json['name'] as String, json['currid'] as int,
      json['hcover'] as String, json['words'] as String);
}
...
Re _$ReFromJson(Map<String, dynamic> json) {
  return Re(json['id'] as int, json['name'] as String, json['currid'] as int,
